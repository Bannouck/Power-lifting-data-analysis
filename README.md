...
Using the "App script" extension on google sheets, we are able to insert the "power lifting data collect" code and collect the data from every sheet in one unique sheet like follows:
